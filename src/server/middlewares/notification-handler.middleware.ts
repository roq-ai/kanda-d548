...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'property.update': {
    ...
    key: 'property-details-updated',
    tenantPath: ['organization', 'user', 'property'],
    userPath: [],
  },
  'client.create': {
    roles: ['business-owner', 'office-manager'],
    key: 'new-client-added',
    tenantPath: ['organization', 'user', 'client'],
    userPath: [],
  },
  'document.update': {
    roles: ['real-estate-agent', 'office-manager'],
    key: 'document-status-updated',
    tenantPath: ['organization', 'user', 'document'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'real-estate-agent', 'office-manager'];
